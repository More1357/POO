...
namespace Clinicamedica
{
    public class ClinicaContext : DbContext
    {
        ...
        {
            options.UseSqlite(@"Data Source=C:\Users\Morena\source\repos\ClinicaMedica\ClinicaMedica\ClinicaMedica.db");
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Especialidad>()
                .Property(e => e.CostoBase).HasColumnName("costo_base");
            ...
            modelBuilder.Entity<Paciente>()
                .Property(p => p.ObraSocial).HasColumnName("obra_social");       
            modelBuilder.Entity<Paciente>()
                .Property(p => p.CoberturaPorcentaje).HasColumnName("cobertura_porcentaje");
